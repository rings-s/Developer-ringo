# Generated by Django 5.1.4 on 2025-03-08 22:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(blank=True, help_text="User's general location for matching with nearby clients", max_length=255)),
                ...
                ('role', models.ForeignKey(help_text='User role determines permissions and access levels', null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.role')),
